    ...
    mostrarPedido(oPedidosActual){
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                let paginaURL = 'https://jesusramirezgamarra.github.io/javascript/Entregable/8_OperadoresAvanzadados' + pagina; // debido a que la estructura de directorios en github es diferente a la esturctura que tengo en local ( git hub le agrega /Javascript)
